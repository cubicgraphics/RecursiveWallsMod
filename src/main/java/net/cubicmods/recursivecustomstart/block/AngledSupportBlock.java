...
public class AngledSupportBlock extends RecursivecustomstartModElements.ModElement {
	@ObjectHolder("recursivecustomstart:angled_support")
	public static final Block block = null;
	public AngledSupportBlock(RecursivecustomstartModElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("angled_support");
		}
